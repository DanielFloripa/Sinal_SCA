...
Stepper;WiFi;WiFi/utility;Wire;Wire/utility;DS1307new;etherShield;ETHER_28J60;Time;\
...
upload: 
	./screen.sh
	#killall screen #fecha automaticamente
	${AVR_DUDE} -v -v -v -v -p${ARDUINO_MODEL} -c${ARDUINO_PROGRAMMER} -P ${COM_PORT} -b${BAUD_RATE} -D -Uflash:w:${CND_ARTIFACT_PATH_${CONF}}.hex:i 
	#screen ${COM_PORT} #abre automaticamente
	screen ${COM_PORT}
